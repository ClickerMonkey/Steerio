...
public class TargetFacingExample extends SteerBasicExample
{
	...
	public void start( Scene scene )
	{
		...
		newSprite( Color.orange, 15, 300, new SteerSet<Vec2>( 1000,
			new SteerAway<Vec2>( 1000, new TargetFacing<Vec2>( sprite, true ) ),
			new SteerDrive<Vec2>( 1000, 0, 0, 100 )
		));

		newSprite( Color.green, 15, 300, new SteerSet<Vec2>( 1000,
			new SteerAway<Vec2>( 1000, new TargetFacing<Vec2>( sprite, false ) ),
			new SteerDrive<Vec2>( 1000, 0, 0, 100 )
		));
	}
