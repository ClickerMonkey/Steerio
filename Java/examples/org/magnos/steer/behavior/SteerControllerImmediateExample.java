...
//		predator.controller.constraint = new ConstraintTurning( 0.1f );
		...
		steerings = new SteerSet<Vec2>(
			new SteerAway<Vec2>( 1000, new TargetLocal<Vec2>( predator, 300 ) ),
			...
			new SteerModifier<Vec2>( 1000, new SteerAlignment<Vec2>( 1000, database, queryAlignment, SpatialDatabase.ALL_GROUPS, SteerAlignment.DEFAULT_MAX_RESULTS, FilterView.fromDegrees( 179.0, FieldOfView.PARTIAL, Vec2.class ) ), 1.0f ),
