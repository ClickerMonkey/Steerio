...
public class TargetInterposeExample extends SteerBasicExample
{
	...
	{
		SteerSprite sprite0 = newSprite( Color.white, 15, 300,
			new SteerWander2( 1000, 0, 100, 150, 80 )
		);
		
		SteerSprite sprite1 = newSprite( Color.lightGray, 15, 300,
			new SteerWander2( 1000, 0, 100, 150, 80 )
		);
		
		newSprite( Color.blue, 15, 300,
			new SteerArrive<Vec2>( 1000, interpose = new TargetInterpose<Vec2>( sprite0, sprite1, 0.25f, Vec2.FACTORY ), 100, 0 )
		);
	}
