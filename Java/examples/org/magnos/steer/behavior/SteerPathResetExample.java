...
public class SteerPathResetExample extends SteerBasicExample
{

	public static void main( String[] args )
	{
		Game game = new SteerPathResetExample( DEFAULT_WIDTH, DEFAULT_HEIGHT );
	...
	public SteerPathResetExample( int w, int h )
	{
		super( w, h );
	}
	...
	{
		steerRed = new SteerPath<Vec2>( 1000, path, 0.01f, 0.05f, 15, 40, 60, 1, true, true, Vec2.FACTORY );
		...
		SteerSprite quicker = newSprite( Color.orange, 15, 300, new SteerSet<Vec2>(
			new SteerPath<Vec2>( 10000, path, 0.01f, 0.025f, 0, 10, 20, 1, true, true, Vec2.FACTORY ),
