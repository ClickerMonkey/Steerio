...
public class TargetOffsetExample extends SteerBasicExample
{
	...
	{
		SteerSprite sprite = newSprite( Color.blue, 15, 200, 
			new SteerWander2( 1000, 0, 100, 150, 80 )
		);

		SteerSprite offsetRelative = newSprite( Color.green, 15, 300, 
			new SteerTo<Vec2>( 1000, targetRelative = new TargetOffset<Vec2>( sprite, new Vec2( -50, 0 ), true ) ) 
		);
		offsetRelative.position.set( 50, 50 );

		SteerSprite offsetAbsolute = newSprite( Color.orange, 15, 300, 
			new SteerTo<Vec2>( 1000, targetAbsolute = new TargetOffset<Vec2>( sprite, new Vec2( -50, 0 ), false ) ) 
		);
